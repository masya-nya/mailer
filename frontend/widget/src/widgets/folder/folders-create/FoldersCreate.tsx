...
export const FoldersCreate = observer((): React.JSX.Element => {
	...
	const [parentFolder, setParentFolder] = useSelect(foldersStore.actionType === CREATE_CHILD ? targetValueInOptions(foldersStore.focusedFolder.path, folderAsOptions) : null);
