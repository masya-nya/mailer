...
export const MemberPlusSvg = ({ width, height, color }: SvgProps): React.JSX.Element => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill={color} width={width + 'px'} height={height + 'px'} viewBox="0 0 32 32">
