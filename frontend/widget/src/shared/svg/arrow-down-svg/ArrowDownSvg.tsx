...
export const ArrowDownSvg = ({ width, height, color, ...props }: SvgProps): React.JSX.Element => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" {...props} fill={'currentColor' || color} width={width + 'px'} height={height + 'px'} viewBox="0 0 96 96">
