...
export const ImportantSvg = ({ width, height, color = 'transparent', clickHandler, colorBG = 'transparent', ...props }: SvgProps): React.JSX.Element => {
	return (
		<svg onClick={clickHandler} {...props} fill={colorBG} width={width + 'px'} height={height + 'px'} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
