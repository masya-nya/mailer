...
export const ArrowBackSvg: FC<SvgProps> = ({ width, height, color, ...props }): React.JSX.Element => {
	return (
		<svg {...props} width={width} height={height} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
