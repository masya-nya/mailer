...
export const ReplyArrowSvg = ({ width, height, color, ...props }: SvgProps): React.JSX.Element => {
	return (
		<svg {...props} width={width + 'px'} height={height + 'px'} viewBox="0 0 24 24" fill='transparent' xmlns="http://www.w3.org/2000/svg">
