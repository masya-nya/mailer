...
export const DeleteSvg: FC<SvgProps> = ({ width, height, color, ...props }): React.JSX.Element => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" {...props} width={width} height={height} viewBox="0 0 24 24" fill="none">
