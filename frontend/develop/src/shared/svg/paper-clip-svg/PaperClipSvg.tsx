...
export const PaperClipSvg = ({ width, height, color }: SvgProps): React.JSX.Element => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width={width + 'px'} height={height + 'px'} viewBox="0 0 24 24">
