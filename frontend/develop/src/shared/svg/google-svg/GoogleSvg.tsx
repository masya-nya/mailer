...
export const GoogleSvg = ({ width, height, color }: SvgProps): React.JSX.Element => {
	return (
		<svg width={width + 'px'} height={height + 'px'} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
