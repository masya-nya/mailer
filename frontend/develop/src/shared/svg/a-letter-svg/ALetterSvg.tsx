...
export const ALetterSvg: FC<SvgProps> = ({ width, height, color }): React.JSX.Element => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 64.000000 64.000000">
