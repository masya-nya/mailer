...
import { LabelInline, InputMulti, InputTransparent, Email, ButtonYandex, InputFile, File } from '../../shared/UI';
		...
		<div className={cl['mail-send']}>
			<div className={cl['mail-send__inputs']}>
				<LabelInline label='Кому' >
					<InputMulti style={{ width: '100%' }} value={emailTo} onChangeHandler={setEmailToHandler} />
				</LabelInline>
